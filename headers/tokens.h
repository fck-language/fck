...
#define TT_SET_MOD    	  35
#define TT_SET_MULT	      36
#define TT_SET_DIV    	  37
#define TT_SET_FDIV    	  38
#define TT_SET_POW    	  39
#define TT_SET_RET	      40
#define TT_SET_RET_PLUS	  41
#define TT_SET_RET_MINUS  42
#define TT_SET_RET_MOD    43
#define TT_SET_RET_MULT   44
#define TT_SET_RET_DIV    45
#define TT_SET_RET_FDIV   46
#define TT_SET_RET_POW    47

std::string VAR_KEYWORDS[] = {"int", "float", "bool", "list", "str", "imag"};
std::string NON_STATIC_VAR_KEYWORDS[] = {"auto"};
